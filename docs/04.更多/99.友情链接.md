...
- name: Lake's blog
  ...
  avatar: https://gcore.jsdelivr.net/gh/taixingyiji/image_store@main/blog/logo/img.png
  link: https://taixingyiji.com/
- name: Cubik的小站 # 昵称
  desc: RECOMMENDED BY DR.CREATIVE # 介绍
  avatar: https://gcore.jsdelivr.net/gh/Cubik65536/cubik-favicons@main/CubikLogo.png # 头像
  link: https://www.cubik65536.top/  # 链接
- name: x·π
  desc: 为开发者量身制作的技术博客和知识库管理平台。
  avatar: https://gcore.jsdelivr.net/gh/Ezuy-Lee/RainzeDrawingBed/media/logo.png
...
- name: 小鱼博客
  desc: 总是半途而废的废柴
  avatar: https://gcore.jsdelivr.net/gh/xiaoyu-666/image_store/blog/minion.png
...
- name: Evan's blog # 昵称
  ...
  avatar: https://gcore.jsdelivr.net/gh/xugaoyi/image_store/blog/20200103123203.jpg # 头像
